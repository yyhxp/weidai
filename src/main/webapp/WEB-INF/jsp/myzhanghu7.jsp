...
<!-- saved from url=(0049)https://www.weidai.com.cn/account/personal/safety -->
<html lang="en">
<head>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/safety.css">
...
<div class="layout clearfix" style="margin-top: 95px;">
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="myzhanghu.jsp">
                ...
                <a href="myzhanghu7.jsp">
                    <li class="cur"><i class="iconfont"></i>个人资料</li>
                </a>
    ...
    <!--用户中心左侧 end-->
    <!--用户中心内容-->
    <div class="memberContent" id="safety">
        ...
        <div class="safetyList clearfix">
            <ul>
                ...
                <li id="noOpen">
                    <label>存管账户</label>
                    <span style="font-size: 12px">与厦门银行合作资金存管，保障您的资金安全</span>
                    <a href="javascript:;" class="fr" id="openBtn">开通</a>
                </li>

                <!-- 实名认证开始 -->
                <li class="realname">
                    <label>实名认证</label>
                    <span style="font-size: 12px">保障账户安全，只有完成实名认证才能投资</span>
                ...
                <li class="loginPsw">
                    <label>登录密码</label>
                    <span style="font-size: 12px">登录微贷网时需要输入的密码</span>
                ...
                <li class="trdPsw">
                    <label>交易密码</label>
                    <span style="font-size: 12px">保障资金安全，请定期更换交易密码,建议您交易密码区别于登录密码</span>
                    <a href="#" class="fr">
                        未设置 </a>
                </li>
                <!-- 交易密码结束 -->
                ...
                <li class="safetyPhone">
                    <label>手机号码</label>
                    <span style="font-size: 12px">175*****120</span>
                    <a href="#" class="fr">查看</a>
                </li>
                <li class="safetyEmail">
                    <label>电子邮箱</label>
                    <span style="font-size: 12px">获取账户资金变动通知和投资讯息，轻松梳理理财信息</span>
                    <a href="#" class="fr">未绑定</a>
                </li>

                <!-- 港澳台 -->
                <li class="bank1">
                    <label>银行卡</label>
                    <span style="font-size: 12px">提现时资金转入的银行卡账户</span>
                    <a href="#" class="fr">未绑定</a>
                </li>

                <li class="safetyContacts">
                    <label>紧急联系人</label>
                    <span style="font-size: 12px">当有紧急情况联系不到您的时候，可以联系您的亲人朋友</span>
                    <a href="#" class="fr">未登记</a>
                </li>
                <li class="evaluationScore">
                    <label>风险承受能力</label>
                    <span style="font-size: 12px">微贷网为您量身打造了风险承受能力评估体系，以获得最佳的投资体验</span>
                    <a href="#" class="fr">立即评估</a>
                </li>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/safety.js.下载"></script>
<script type="text/javascript">
    //用户开通存管
    ...
    //企业开通存管
    $('#entOpenAccount').click(function () {
        $("#cunguanResult").show();
        window.open("/regs/entOpenAccount?uid=" + 14040589);
    });

    //港澳台开通存管
    $('#hkatOpenAccount').click(function () {
        $("#cunguanResult").show();
        window.open("/regs/hkatOpenAccount?uid=" + 14040589);
    });
    ...
    function showAlertBox(msg) {
        var alertHtml = '<div class="success">' + msg + '</div>';
...
<script src="../myzhanghu/myzhanghu_files/index-shunliu.js"></script>
</body>
</html>