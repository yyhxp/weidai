...
<!-- saved from url=(0063)https://www.weidai.com.cn/account/receivables/receivablesDetail -->
<html lang="zh-cn">
<head>
...
<link rel="shortcut icon" href="https://www.weidai.com.cn/favorite.ico"
	type="image/x-icon">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/myzhanghu_files/jquery-1.10.1.min.js.下载"></script>
<style type="text/css">
#waf_nc_block {
	position: fixed;
	_position: absolute;
...
<script
	src="${pageContext.request.contextPath }/statics/myzhanghu_files/nc.js.下载"></script>
<style type="text/css">
...
.omeo-code .omeo-switch {
	...
	background-image:
		url("//g.alicdn.com/sd/ncpc/${pageContext.request.contextPath }/statics/images/checkcode.png");
	background-repeat: no-repeat
}
...
.nc_hand {
	...
	height: 53px;
	background-image:
		url("//g.alicdn.com/sd/ncpc/${pageContext.request.contextPath }/statics/images/hand.png");
	z-index: 3
}
...
.nc_slide_button {
	...
	cursor: move;
	background: #fff
		url("//g.alicdn.com/sd/ncpc/${pageContext.request.contextPath }/statics/images/rt.png")
		no-repeat center;
	z-index: 2
}
...
.nc-container .nc_scale .btnok {
	cursor: default;
	background: #fff
		url("//g.alicdn.com/sd/ncpc/${pageContext.request.contextPath }/statics/images/yes.png")
		no-repeat center;
	z-index: 3
}
...
.nc-container .nc_scale .btnok2 {
	...
	font-size: 20px;
	background: #fff
		url("//g.alicdn.com/sd/ncpc/${pageContext.request.contextPath }/statics/images/no.png")
		no-repeat center;
	z-index: 3
}
...
<body>
	...
	<div class="gd-header">
		<div class="gd-header-a1">
			<div>
				<a href="indexjsp" class="weidaiwang1">微贷网</a>
				<ul>
					<a href="">
						<li style="padding-bottom: 5px;">首页</li> </a>
					<a href="x-tou.jsp">
						<li style="padding-bottom: 5px;">我要出借</li> </a>
					<a href="${pageContext.request.contextPath }/test/loan.html">
	...
	<div class="gd-drop-down">
		<div class="gb-drop-dowm-a1">
			<ul>
				<li><a href="x-tou.jsp">X智投</a>
				</li>
				<li><a href="zhitou.jsp">优选智投</a>
				</li>
				<li><a href="sanbiao.jsp">散标列表</a>
				</li>
				<li><a
					href="${pageContext.request.contextPath }/user/zhuanrang.html">转让专区</a>
				</li>
			</ul>
			<ul style="width: 900px;">
				...
				<li><a href="${pageContext.request.contextPath }/ditu/ditu.html">联系我们</a>
				</li>
				<li><a href="">法人签章</a>
				</li>
			</ul>
	...
	<div class="wdpc-header-01">
		<div class="wdpc-header-02">
			<ul>
				<li class="wdpc-header-push"><a href="x-tou.jsp">X智投</a>
				</li>
				<li class="wdpc-header-push"><a href="zhitou.jsp">优选智投</a>
				</li>
				<li class="wdpc-header-push"><a href="sanbiao.jsp">散标列表</a>
				</li>
	...
	<div class="wdpc-header-01">
		<div class="wdpc-header-02">
			<ul>
				<li class="wdpc-header-push"><a href="">银行资金存管</a>
				</li>
				<li class="wdpc-header-push"><a href="">运营报告</a>
				</li>
				<li class="wdpc-header-push"><a href="">备案信息</a>
				</li>
				<li class="wdpc-header-push"><a href="">组织信息</a>
				</li>
				<li class="wdpc-header-push"><a href="">审核信息</a>
				</li>
				<li class="wdpc-header-push"><a href="">经营信息</a>
				</li>
				<li class="wdpc-header-push"><a href="">监管法规</a>
				</li>
				<li class="wdpc-header-push"><a
					href="${pageContext.request.contextPath }/ditu/ditu.html">联系我们</a>
				</li>
				<li class="wdpc-header-push"><a href="">法人签章</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="wdpc-header-01">
		<div class="wdpc-header-02">
			<ul>
				<li class="wdpc-header-push"><a href="">微贷简介</a>
				</li>
				<li class="wdpc-header-push"><a href="">微贷风采</a>
				</li>
				<li class="wdpc-header-push"><a href="">企业内刊</a>
				</li>
				<li class="wdpc-header-push"><a href="">新闻公告</a>
				</li>
				<li class="wdpc-header-push"><a
					href="${pageContext.request.contextPath }/ditu/ditu.html">联系我们</a>
				</li>
				<li class="wdpc-header-push"><a href="">人才招聘</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<link rel="stylesheet" type="text/css"
		href="${pageContext.request.contextPath }/statics/myzhanghu_files/datePickerRange.css">
	<!--用户中心-->
...
.userInfo .tip_info {
	...
	height: 42px;
	background-image:
		url("https://static4.weidai.com.cn/static/common/weiPc/img/center/tip_bg.png");
	background-repeat: no-repeat;
	position: absolute;
	white-space: nowrap;
	left: -22px;
...
.userInfo .tip_info a {
	...
	right: 12px;
			...
			<div class="mNav" id="mNavId">
				<ul>
					...
					<a href="${pageContext.request.contextPath }/test/management">
						<li><i class="iconfont"></i>资金管理</li> </a>
					<a href="${pageContext.request.contextPath }/test/record">
						<li><i class="iconfont"></i>出借记录</li> </a>
					<a href="${pageContext.request.contextPath }/test/gathering">
						<li class="cur"><i class="iconfont"></i>收款明细</li> </a>
					<a href="${pageContext.request.contextPath }/test/">
						<li><i class="iconfont"></i>银行卡</li> </a>
					<a href="${pageContext.request.contextPath }/user/myzhanghu5.html">
		...
		<div class="memberContent" id="shoukuan-daishou">
			<div class="chongzhiTop">
				<h3>收款明细</h3>
			</div>
			<div class="chongzhiNav clearfix">
				<ul>
					<li id="daishou" class="cur"><a href="#">待收明细</a></li>
					<li id="yishou" ><a href="#">已收明细</a></li>

				</ul>
			</div>
			<!-- <div class="productDivision">
				<ul class="clearfix">
					<li class="cur"><a href="#">优选智投</a>
					</li>
					<li class="sanbiao"><a href="#">散标</a>
				</ul>
			</div> -->
			
	<div  id="weishou" style="display:;">		
			<p class="weishouDetail">
				<span style="font-size: 14px">未收本金：<em
					style="font-size: 14px">0.00</em>元</span> <span style="font-size: 14px">未收利息：<em
					style="font-size: 14px">0.00</em>元</span>
			</p>

			<div class="tiaojian clearfix" id="dateRange">
				<ul>
					<li class="cur" style="font-size: 12px">全部</li>
					<li style="font-size: 12px">未来1个月</li>
					<li style="font-size: 12px">未来3个月</li>
					<li style="font-size: 12px">未来12个月</li>
				</ul>
				
				<div class="riqi" id="allStatus" style="font-size: 12px">
					日期： <input type="text" id="startDate"> <label>—</label> <input
						type="text" id="endDate">
					<button type="button" class="button button-sm button-special"
						id="chaxun">查询</button>
					<div class="datapicker touziRiqi" id="datapicker"></div>
					<div class="datapicker touziRiqi" id="datapicker1"
						style="left:155px;"></div>
 ...
 -->
			<div class="answer">
				<ul class="title">
					<li class="tal"
						style="width:11%;box-sizing:border-box;padding-left:2%;+width:10%;">期数</li>
				...
				<ul class="title">
					<li class="tal"
						style="width:11%;box-sizing:border-box;padding-left:2%;+width:10%;">一期</li>
					<li class="tal" style="width:17%;">优选智投1号</li>
					<li>2017-8-13</li>
					<li class="tar">200</li>
					<li class="tar">500</li>
					<li class="tar">100</li>
					<li style="width:15%;">待收</li>
				</ul>												
			</div>
			</div>
		...
		<!-- <div  id="yishou" style="display:;">
	<p class="yishoushouDetail">
				<span style="font-size: 14px">已收本金：<em
					style="font-size: 14px">0.00</em>元</span> <span style="font-size: 14px">已收利息：<em
					style="font-size: 14px">0.00</em>元</span>
			</p>
			...
			<div class="tiaojian clearfix" id="dateRange">
				<ul>
					<li class="cur" style="font-size: 12px">全部</li>
					<li style="font-size: 12px">过去1个月</li>
					<li style="font-size: 12px">过去3个月</li>
					<li style="font-size: 12px">过去12个月</li>
				</ul>
			...
			<div class="answer">
				<ul class="title">
					...
					<li class="tal" style="width:17%;">项目名称</li>
					<li>已收日期</li>
					<li class="tar">已收本息(元)</li>
					<li class="tar">已收本金(元)</li>
					<li class="tar">已收利息(元)</li>
					<li style="width:15%;">状态</li>
				</ul>
				<ul class="title">
					<li class="tal"
			...
			<div class="empty" style="">
				<img
					src="${pageContext.request.contextPath }/statics/myzhanghu_files/empty1.png"
					alt="">
				<p class="text">您距离躺着赚钱，只剩动动手指出借啦！</p>

				<p class="btn">
					<a href="${pageContext.request.contextPath }/bid/sanbiao.html">
						<button class="center_btn_a">立即投资</button> </a>
				</p>
			</div>
		</div>
		<!--用户中心内容 end-->
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/statics/myzhanghu_files/DatePickerRange.js.下载"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/statics/myzhanghu_files/riqiSearch.js.下载"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/statics/myzhanghu_files/shoukuan-daishou.js.下载"></script>
			...
			<div class="footer-a2">
				<div class="footer-left">
					<dl>
						...
						<dd>
							<a href="${pageContext.request.contextPath }/ditu/ditu.html">联系我们</a>
						</dd>
						<dd>
							<a href="">人才招聘</a>
						</dd>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/myzhanghu3.js"></script>
	<script>
    suspend();
    suspend1();
    suspend2();
