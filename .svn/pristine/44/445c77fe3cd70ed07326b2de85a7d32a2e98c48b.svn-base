...
<head>
    <meta charset="UTF-8">
    <title>微贷网--散标列表</title>
    <link href="${pageContext.request.contextPath }/statics/css/zhitou.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/jquery.min.js"></script>
</head>
<style type="text/css">
      .footer-right>dl>dd>span {
    background: url(${pageContext.request.contextPath }/statics/images/seeUs1x1Mmcs.png);
    display: block;
    width: 95px;
    height: 95px;
    margin-left: 10px;
...
.floatBtn1-ax > i {
    ...
    height: 20px; 
    display: block;
    background: url('${pageContext.request.contextPath }/statics/images/背景(19).png');
}
.floatBtn1-ax1 {
    width: 20px;
    height: 20px;
...
.floatBtn1-ax1 > i {
    ...
    height: 20px;
    display: block;
    background: url('${pageContext.request.contextPath }/statics/images/背景(20).png');
}
.floatBtn1-ax2 {
    width: 25px;
    height: 19px;
...
.floatBtn1-ax2 > i {
    ...
    height: 19px;
    display: block;
    background: url('${pageContext.request.contextPath }/statics/images/背景(21).png');
}
.floatBtn1-ax3 {
    width: 20px;
    height: 20px;
...
.floatBtn1-ax3 > i {
    ...
    height: 20px;
    display: block;
    background: url('${pageContext.request.contextPath }/statics/images/背景(22).png');
}
.floatBtn1-ax4 {
    width: 20px;
    height: 20px;
...
.floatBtn1-ax4 > i {
    ...
    height: 20px;
    display: block;
    background: url('${pageContext.request.contextPath }/statics/images/背景(23).png');
}
.floatBtn1-ax5 {
    width: 21px;
    height: 12px;
...
<body>
      <!-- 我的兄弟叫顺溜之固定顶部 -->
        ...
        <div class="floatBtn1">
            <ul>
                ...
                <a href="${pageContext.request.contextPath}/jsp/calcultor.jsp">
                    <li>
  		...
  		<%@ include file="mydaohang.jsp"  %>
            ...
            <div class="wdpc-header-a2">
                ...
                <ul class="actived">
                    ...
                    <a href="${pageContext.request.contextPath }/bid/xBid.html">
        ...
        <div class="wdpc-header-01">
            <div class="wdpc-header-02">
                <ul>
                    ...
                    <li class="wdpc-header-push">
                        <a href="${pageContext.request.contextPath }/bids/zhbids.html">散标列表</a>
                    </li>
                    <li class="wdpc-header-push">
                        <a href="${pageContext.request.contextPath }/user/zhuanrang.html">转让专区</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="mean" style="margin-top: 45px">
        <div style="width: 50px;height: 50px">

        </div>
        <div id="bg_img" >
            <img src="${pageContext.request.contextPath }/statics/images/listBanner02.png">
        </div>
        <div id="top">
            <ul>
                <li style="margin-left: 250px;"><a href="${pageContext.request.contextPath }/bid/zhitou.html" style="color:black;font-size:16px">优选智投</a> </li>
                <li style="border-bottom: 3px solid #36adf7"><a href="${pageContext.request.contextPath }/bids/zhbids.html" style="color:black;font-size:16px">散标列表</a> </li>
                <li><a href="${pageContext.request.contextPath }/bid/xBid.html" style="color:black;font-size:16px">X智投</a> </li>
                      <li><a href="${pageContext.request.contextPath }/user/zhuanrang.html" style="color:black;font-size:16px">转让专区</a> </li>
            </ul>
        </div>
        <div id="type">
         ...
         <input id="PageContext" type="hidden" value="${pageContext.request.contextPath}" />
            <ul>
                <li>项目期限：</li>
                <li class="cur"  onclick="ewq()"  style="color: #36adf7">全部</li>
                <li class="month" onclick="ewq1()" style="color:black" value="1">3个月</li>
                <li class="month1" onclick="ewq2()" style="color:black" value="3">3-12个月</li>
                <li class="month2" onclick="ewq3()" style="color:black" value="2">12个月以上</li>
            </ul>          
            <br></br>
            <ul>
                <li>总体排序：</li>
                <li><a href="#" style="color: #36adf7">综合</a></li>
                <li><a href="#" style="color:black">预计利率</a></li>
                <li><a href="#" style="color:black">项目期限</a></li>
            </ul>             
        </div>
        <br></br>
        <div id="content">

            <table class="style-Lend-3-01a">
                 
                	<tr class="tr">
                        <td>                   
                            <label id="sanbiaoName" style="position: absolute;top: 20px">${zhitou.bdTitle}</label>
                            <p style="color: #ff5722;font-size: 24px;font-weight: 500">${zhitou.bdLilv}%</p>

            <table class="tr">
              	<%--   <tr >
                        <td>
                            <label style="position: absolute;top: 20px">${sanbiao.bdTitle}</label>
                            <p style="color: #ff5722;font-size: 24px;font-weight: 500">${sanbiao.bdLilv}%</p>
<<<<<<< .mine

                            <span>预期利率</span>
                        </td>
                        <td>
                            <p><label style="font-size: 24px">${zhitou.bdTime}</label>个月</p>
                            <span>项目期限</span>
                        </td>
                        <td>
                            <p>${zhitou.bdSum }元</p>
                        ...
                        <td>
                            ...
                            <div style="width: 190px;height: 5px;background-color: #eeeeee">
                                <div style="width:${((zhitou.bdSum - zhitou.bdExitsum)/zhitou.bdSum)*100}%;height: 5px;background: linear-gradient(90deg,#1f98fd,#02f1de)"></div>
                            </div>
                            </p>
                            <span>进度：<fmt:formatNumber value="${((zhitou.bdSum - zhitou.bdExitsum)/zhitou.bdSum)*100}" pattern="##" minFractionDigits="0" ></fmt:formatNumber>${((zhitou.bdSum - zhitou.bdExitsum)/zhitou.bdSum)*100}%</span>
                        </td>
<<<<<<< .mine
                        <td><a href="${pageContext.request.contextPath }/jsp/buy.jsp?order=${zhitou.bdId}" style="margin-left: 20px;font-size: 14px;color: #00A2CA">立即购买</a></td>
                    </tr> 
         

                        <td><a href="${pageContext.request.contextPath }/jsp/buy.jsp?order=${sanbiao.bdId}" style="margin-left: 20px;font-size: 14px;color: #00A2CA">立即购买</a></td>
                    </tr> --%>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/sanbiao.js"></script>
<script type="text/javascript">
    $("#type ul li a").click(function () {
        $(this).css("color","#36adf7")
        $("#type ul li a").not(this).css("color","black");
    })
</script>
<%-- 	   <script type="text/javascript"
