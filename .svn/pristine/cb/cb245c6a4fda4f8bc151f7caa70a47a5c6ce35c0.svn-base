...
<!-- saved from url=(0057)https://www.weidai.com.cn/goldFinancialPlannerIndex/entry -->
<html lang="en">
<head>
...
<!-- 我的兄弟叫顺溜之透明层 -->
<div class="touming" style="height: 1824px;">
</div>
 <!-- 我的兄弟叫顺溜之导航 -->
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/index.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myzhanghu_files/common.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/index(1).css">
...
<div class="layout clearfix" style="margin-top:95px;">
    ...
    <!--用户中心左侧-->
    <div class="memberLeft" style="height: 1305px;">
        <div class="userInfo">
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="myzhanghu.jsp">
                ...
                <a href="myzhanghu9.jsp">
                    <li class="cur"><i class="iconfont"></i>邀请有礼</li>
                </a>
    ...
    <!--用户中心左侧 end-->
    <!--用户中心内容-->
    <div class="memberContent" id="goldIndex">
        <img src="./${pageContext.request.contextPath }/statics/images/index1x.jpg"
             srcset="#"
             alt="">

        <div class="actionBox" style="width: 270px;height: 74px;margin-left: 38%;position: relative;top: -100px">
            <a href="#" class="inputBut center_btn_a becomeGold disable fp-button"
               id="btn-tobe" style="margin-top: 480px">成为理财师</a>

            <div class="agreement" style="margin-left: 15px"><i class="radius-sm check" id="agreementId"></i><a
                    href="javascript:;" class="blue" target="_blank" id="lawBtn">《微贷网“金牌理财师”推荐奖励计划》</a></div>
        </div>
    </div>
    <!--用户中心内容 end-->
</div>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/index.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/index.js(1).下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/index.js(2).下载"></script>
<script type="text/javascript">
    $(function () {
