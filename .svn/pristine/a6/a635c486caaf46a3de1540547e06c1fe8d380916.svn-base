...
<!-- saved from url=(0038)https://www.weidai.com.cn/account/bank -->
<html lang="en">
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/index-shunliu.css">
...
<script type="text/javascript">
    var urlbase = "";
    var staticUrl = "https://static4.weidai.com.cn/static/common/weiPc";
</script>
...
<div class="layout borderGray bgWhite clearfix" style="margin-top:95px">
    <!--用户中心左侧-->
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="myzhanghu.jsp">
                ...
                <a href="myzhanghu4.jsp">
                    <li class="cur"><i class="iconfont"></i>银行卡</li>
                </a>
    ...
    <!--用户中心左侧 end-->
    <!--用户中心内容-->
    <div class="memberContent" id="bank">
        <div class="chongzhiTop">
            <h3>我的银行卡</h3>
        </div>
        <p class="addbank-tip">为了保障你的资金安全，每个账号只能绑定<em class="font-orange" style="font-size: 13px">1</em>张银行卡，绑定成功后该卡将作为您<em
                class="font-orange" style="font-size: 13px">充值提现时使用的唯一一张银行卡，绑定成功后不可修改</em></p>

        <div class="addbank radius-sm">
            <p class="save-icon"><i class="radius-sm">储蓄卡</i></p>

            <p class="add-icon" id="addCard" style="cursor: pointer;"><i>+</i></p>

            <p class="text font-gray">添加银行卡</p>
        </div>

        <ol class="olTips">
            <li><b style="font-size:14px">温馨提示</b></li>
            <li style="font-size:14px">1、快捷充值和提现采用同卡进出原则，即提现银行卡需与快捷充值银行卡一致，确保资金仅能提现至您本人银行卡。</li>
            <li style="font-size:14px">2、您选择的银行卡开户名必须与您的微贷网实名认证一致，否则提现申请将无法提交。</li>
            <li style="font-size:14px">3、如有疑问，请联系客服：400-028-8888（工作日9:00-21:00）。</li>
        </ol>
    </div>
    <!--用户中心内容 end-->
</div>
<!--弹框开始-->
<div class="alertbox" id="complete-bankInfo" style="display: none;">
    <div class="shadow"></div>
    <!--  选择银行卡开户行信息-->
    <div class="alert" style="position: absolute;">
        <div class="title font-black">
            完善开户行
            <span>请完善开户行信息，提现更快速哦！</span> <i class="closebtn fr"></i>
        </div>
        <div class="content content-pw bank-pw">
            <form>
                <span class="error font-orange area-mes"></span>

                <div class="content-main">
                    <div>
                        <p>
                            <label for="">开户地区：</label>
                            <input type="text" value="" provincenum="" placeholder="请选择省" readonly=""
                                   class="privince-input">
                            <input type="text" value="" placeholder="请先选择省" readonly="" class="city-input">
                        </p>
                        <ul class="privince unvisible" name="">
                            <li value="北京市" provincenum="1">北京市</li>
                            <li value="天津市" provincenum="2">天津市</li>
                            <li value="上海市" provincenum="3">上海市</li>
                            <li value="重庆市" provincenum="4">重庆市</li>
                            <li value="河北省" provincenum="5">河北省</li>
                            <li value="河南省" provincenum="6">河南省</li>
                            <li value="云南省" provincenum="7">云南省</li>
                            <li value="辽宁省" provincenum="8">辽宁省</li>
                            <li value="黑龙江省" provincenum="9">黑龙江省</li>
                            <li value="湖南省" provincenum="10">湖南省</li>
                            <li value="安徽省" provincenum="11">安徽省</li>
                            <li value="山东省" provincenum="12">山东省</li>
                            <li value="新疆维吾尔自治区" provincenum="13">新疆维吾尔自治区</li>
                            <li value="江苏省" provincenum="14">江苏省</li>
                            <li value="浙江省" provincenum="15">浙江省</li>
                            <li value="江西省" provincenum="16">江西省</li>
                            <li value="湖北省" provincenum="17">湖北省</li>
                            <li value="广西壮族" provincenum="18">广西壮族</li>
                            <li value="甘肃省" provincenum="19">甘肃省</li>
                            <li value="山西省" provincenum="20">山西省</li>
                            <li value="内蒙古自治区" provincenum="21">内蒙古自治区</li>
                            <li value="陕西省" provincenum="22">陕西省</li>
                            <li value="吉林省" provincenum="23">吉林省</li>
                            <li value="福建省" provincenum="24">福建省</li>
                            <li value="贵州省" provincenum="25">贵州省</li>
                            <li value="广东省" provincenum="26">广东省</li>
                            <li value="青海省" provincenum="27">青海省</li>
                            <li value="西藏" provincenum="28">西藏</li>
                            <li value="四川省" provincenum="29">四川省</li>
                            <li value="宁夏回族" provincenum="30">宁夏回族</li>
                            <li value="海南省" provincenum="31">海南省</li>
                            <li value="台湾省" provincenum="32">台湾省</li>
                            <li value="香港特别行政区" provincenum="33">香港特别行政区</li>
                            <li value="澳门特别行政区" provincenum="34">澳门特别行政区</li>
                        </ul>
                        <ul class="city unvisible" name=""></ul>
                    </div>
                    <div class="mini-index">
                        <p>
                            <label for="">开户支行：</label>
                            <input type="text" value="" placeholder="请填写开户支行" class="select-card-input long">
                        </p>
                        <!-- <ul class="select-card big unvisible" name="">
            <li>建设银行</li>
            <li>中国银行</li>
            <li>工商银行</li>
            <li>农业银行</li>
            <li>建设银行</li>
                ...
                <a href="javascript:;" class="submit" id="chose-pay">确定</a></form>
        </div>
    </div>
</div>
...
<div class="alertbox" id="cunguanTips">
    ...
    <div class="alert cunguan">
        ...
        <div class="content">
            ...
            <div id="tips1"><p class="font-16">绑定银行卡需在开通银行存管账户页执行</p>

                <p>微贷网联手厦门银行，开通银行资金存管账户，保证您的资金安全!</p></div>
            <p class="buttons">
                <a href="javascript:;" class="button button-normal radius-sm" id="openNow">开通并绑定</a>
            </p>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/bindbank.js.下载"></script>
<script type="text/javascript">
    $(function () {
        $("#tips1").html("<p class='font-16'>绑定银行卡需在开通银行存管账户页执行</p><p>微贷网联手厦门银行，开通银行资金存管账户，保证您的资金安全!</p>");
        $("#openNow").html("开通并绑定");
    });
    ...
    $("#addCard").click(function () {
        ...
        if ('1' == '-1' || '0' == '-1') {
            showAlertBox("系统异常，请稍后再试");
        } else {
            if ('1' == '0') {
                window.location.href = "/account/bankAdd.html";
            } else {
                if ('0' != '2') {
                    $("#cunguanTips").show();
                } else {
                    $("#tips2").html("<p class='font-16'>请您在新打开的页面中绑定银行卡，开通之前请不要关闭此页面！</p>");
                    $("#openSucc").html("绑定成功");
                    $("#cunguanResult").show();
                    window.open("/deposit/toBindBankcard.html");
                }
            }
        }
    });
