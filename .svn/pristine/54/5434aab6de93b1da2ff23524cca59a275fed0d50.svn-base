...
<!-- saved from url=(0050)https://www.weidai.com.cn/account/addRateRedPacket -->
<html lang="en">
<head>
...
<title>我的红包</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/normalize(1).css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/weidai(1).css">
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/myRedPacket.css">
<!-- <link rel="stylesheet" type="text/css" href="https://static4.weidai.com.cn/static/common/weiPc/css/candy.css"> -->
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/myzhanghu_files/alertbox1(1).css" media="screen" title="no title" charset="utf-8">
...
<div class="layout clearfix" style="margin-top: 95px">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/page.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/center1(1).css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/center_common(1).css">
    ...
    <div class="memberLeft" style="height: 900px;">
        <div class="userInfo">
            ...
            <p>
                ...
                <a href="#" class="yellow-span level level0"></a>
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="myzhanghu.jsp">
                ...
                <a href="myzhanghu8.jsp">
                    <li class="cur"><i class="iconfont"></i>我的红包</li>
                </a>
    ...
    <div class="memberContent" id="zichan-all">
        ...
        <div class="redTitle clearfix  chongzhiNav">
            <ul>
                <li class="cur"><a href="javascript:;" style="font-size: 14px">加息红包</a></li>
                <li><a href="#" style="font-size: 14px">抵扣红包</a></li>
            </ul>
            <a href="#" class="fr blue">红包使用规则</a>
        </div>
        <div class="clearfix redTitle2" id="redTitle2">
            <ul class="fl">
                <li class="cur"><a href="javascript:;" id="keYong">可用红包(1)</a></li>
                <li><a href="javascript:;" id="yiYong">已用红包(0)</a></li>
                <li><a href="javascript:;" id="guoQi">过期红包(0)</a></li>
                <li><a href="javascript:;" id="dongJie">冻结中(0)</a></li>
            </ul>
        </div>
        <div class="redBox clearfix">
            <div class="tabBox" id="keYongBox" style="display:block;">
                <div class="item"><i class="rmb"></i>

                    <div class="itemLeft fz14">
                        <div class="clearfix">
                            <div class="tl fl"><span class="DinFont orangeColor">1.8%</span></div>
                            <div class="tr fl"><p class="grayDarkColor fz12">新手福利</p>

                                <p style="font-size: 13px"> 适用500元-50,000元 </p></div>
                        </div>
                        <div class="clearfix grayDarkColor"><p style="font-size:14px;color:#9e9e9e"> 适用29天-95天
                            (X智投、新手专享商品不可用) </p>

                            <p style="font-size:14px;color:#9e9e9e">2018-6-4 14:50:11 至 2018-6-19 23:59:59</p>

                            <p class="orangeColor mt10" style="font-size:14px;">剩余9天过期</p></div>
                    </div>
                    <div class="verticalBox">
                        <div class="contentBox"><a href="#" class="unused"
                                                   data-id="37769616">立即使用 </a></div>
                    </div>
                </div>
            </div>
            <div class="tabBox" id="yiYongBox">
            </div>
            <div class="tabBox" id="guoQiBox">
            </div>
            <div class="tabBox" id="dongJieBox">
            </div>
        </div>
        <div class="pageList"></div>
        <div class="empty" style="display:none">
            <img src="${pageContext.request.contextPath }/statics/myzhanghu_files/empty2.png" alt="">

            <p class="text">暂时没有对应红包</p>
        </div>
...
<!--散标明细弹框开始-->
<div class="alertbox" id="spread">
</div>
<!--散标明细弹框结束-->
<!--优选智投弹框开始-->
<div class="alertbox" id="better">
</div>
<!--优选智投弹框结束-->
<!--优选智投查看详情弹框开始-->
<div class="alertbox" id="better-detials">
</div>
<!--优选智投查看详情弹框结束-->
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/jquery-1.10.1.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/doT.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/woqu.base.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/ratePacketPageAiax.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/myRedPacketDetials.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/alert.js.下载"></script>

<!--<script type="text/x-dot-tempalte" id="tabBox-tpl">
       &lt;!&ndash;{{~it.array:value:index}}
    <div class="item">
      <i class="rmb"></i>
      <div class="itemLeft fz14">
          <div class="clearfix">
             <div class="tl fl"><span class="DinFont orangeColor">{{=value.couponRatio}}%</span></div>
             <div class="tr fl">
                <p class="grayDarkColor fz12">{{=value.couponName}}</p>
                <p>
                     {{?value.minAmount !== null}}
                        {{?value.maxAmount ==null}}
                        单笔投资{{=woqu.formatMoney(value.minAmount)}}元起用
                        {{??}}
                        适用{{=woqu.formatMoney(value.minAmount)}}元-{{=woqu.formatMoney(value.maxAmount)}}元
                        {{?}}
                     {{??}}
                        {{?value.maxAmount !==null}}
                        单笔投资最高{{=value.maxAmount}}
                        {{??}}
                        投资金额无限制
                        {{?}}
                     {{?}}
          ...
          <div class="clearfix grayDarkColor">
            <p>
            {{?value.minDeadline !== null}}
                {{?value.maxDeadline == null}}
                    适用项目{{=value.minDeadline}}天及以上
                {{??}}
                    适用{{=value.minDeadline}}天-{{=value.maxDeadline}}天
                {{?}}
            {{??}}
                {{?value.maxDeadline !==null}}
                    适用期限最长{{=value.maxDeadline}}天
                {{??}}
                    项目期限无限制
                {{?}}
            {{?}}
            ({{=value.formattedLimitCondition}})
            </p>
            <p>{{=value.startTime}} 至 {{=value.endTime}}</p>
            <p class="orangeColor mt10">{{=value.surplusTime}}</p>
          </div>
      </div>
     {{?value.status==2}}
        <div class="verticalBox">
            <div class="contentBox">
                <a href="/list/showBidList" class={{=value.buttonClass}} data-id={{=value.id}}>{{=value.buttonText}}
                {{?value.memberGradeLimit!=null}}
                {{=value.memberGradeLimit}}
                {{?}}
                </a>
            </div>
        </div>
      {{??}}
       <div class="verticalBox">
            <div class="contentBox">
                <a href="#" class={{=value.buttonClass}} data-id={{=value.id}}>{{=value.buttonText}}
                {{?value.memberGradeLimit!=null}}
                {{=value.memberGradeLimit}}
                {{?}}
                </a>
