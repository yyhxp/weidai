...
function floatBtn() {
    $('.floatBtn > ul > a > li:eq(0)').mouseover(function() {
        $('.floatBtn-ax > i').css('display','none');
        $('.floatBtn-ax > span').css('display','block');
        $('.floatBtn-ax > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax > span').css('display','none');
        $('.floatBtn-ax > i').css('display','block');
    });
    $('.floatBtn > ul > a > li:eq(1)').mouseover(function() {
        $('.floatBtn-ax1 > i').css('display','none');
        $('.floatBtn-ax1 > span').css('display','block');
        $('.floatBtn-ax1 > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax1 > span').css('display','none');
        $('.floatBtn-ax1 > i').css('display','block');
    });
    $('.floatBtn > ul > a > li:eq(2)').mouseover(function() {
        $('.floatBtn-ax2 > i').css('display','none');
        $('.floatBtn-ax2 > span').css('display','block');
        $('.floatBtn-ax2 > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax2 > span').css('display','none');
        $('.floatBtn-ax2 > i').css('display','block');
    });
    $('.floatBtn > ul > a > li:eq(3)').mouseover(function() {
        $('.floatBtn-ax3 > i').css('display','none');
        $('.floatBtn-ax3 > span').css('display','block');
        $('.floatBtn-ax3 > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax3 > span').css('display','none');
        $('.floatBtn-ax3 > i').css('display','block');
    });
    $('.floatBtn > ul > a > li:eq(4)').mouseover(function() {
        $('.floatBtn-ax4> i').css('display','none');
        $('.floatBtn-ax4 > span').css('display','block');
        $('.floatBtn-ax4 > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax4 > span').css('display','none');
        $('.floatBtn-ax4 > i').css('display','block');
    });
    $('.floatBtn > ul > a > li:eq(5)').mouseover(function() {
        $('.floatBtn-ax5 > i').css('display','none');
        $('.floatBtn-ax5 > span').css('display','block');
        $('.floatBtn-ax5 > span').css('z-index','0');
    }).mouseout(function() {
        $('.floatBtn-ax5 > span').css('display','none');
        $('.floatBtn-ax5 > i').css('display','block');
    });
}
