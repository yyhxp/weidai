...
<!-- saved from url=(0055)https://www.weidai.com.cn/account/debtRight/canTransfer -->
<html lang="en">
<head>
    ...
    <link id="bs-css" href="${pageContext.request.contextPath }/statics/localcss/bootstrap-cerulean.css" rel="stylesheet">
	<link href="${pageContext.request.contextPath }/statics/localcss/bootstrap-responsive.css" rel="stylesheet">
	<link href="${pageContext.request.contextPath }/statics/localcss/charisma-app.css" rel="stylesheet">
	 <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/localcss/jquery.page.css">
...
<div class="layout clearfix" style="margin-top:95px">
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="${pageContext.request.contextPath }/test/personage.html">
                ...
                <a href="myzhanghu5.jsp">
                    <li class="cur"><i class="iconfont"></i>债权转让</li>
                </a>
    ...
    <div class="memberContent" id="zhaiquan-kezhuan" style="padding-bottom: 10px;">
        <div class="chongzhiTop">
            <h3>债权转让</h3>
        </div>
        <div class="chongzhiNav clearfix" id="chongzhiNav">
            <ul id="tableHeader">
                <li id="likz" class="cur"><a id="kz" style="cursor:pointer" value="kz"  onclick="kz()">可转让</a></li>
                <li id="lizz"><a id="zz" style="cursor:pointer" value="zz" onclick="zz()">转让中</a></li>
                <li id="liyz"><a id="yz" style="cursor:pointer" value="yz" onclick="yz()">已转让</a></li>
                <li id="liyj"><a id="yj" style="cursor:pointer" value="yj" onclick="yj()">已承接</a></li>
            </ul>
        </div>
						...
						<table class="table table-striped">
							<!--   <thead>
								  <tr>
									  ...
									  <th style="font-size: 12px;">待收本息(元)</th>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/myzhanghu5.js"></script>
</html>