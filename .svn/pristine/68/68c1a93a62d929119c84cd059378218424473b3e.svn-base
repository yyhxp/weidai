...
<!-- saved from url=(0056)https://www.weidai.com.cn/account/tender/tenderDetailAll -->
<html lang="en">
<head>
...
<!-- 我的兄弟叫顺溜之透明层 -->
<div class="touming" style="height: 1396px;">
</div>
 <!-- 我的兄弟叫顺溜之导航 -->
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/datePickerRange.css">
<!--用户中心-->
...
top: -53px;">
    ...
    <div class="memberLeft" style="height: 900px;">
        <div class="userInfo">
            ...
            <p>
                ...
                <a href="indexjsp" class="yellow-span level"></a>
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="${pageContext.request.contextPath }/test/personage.html">
                ...
                <a href="${pageContext.request.contextPath }/test/records">
                    <li class="cur"><i class="iconfont"></i>出借记录</li>
                </a>
    ...
    <div class="memberContent">
        ...
        <div class="chongzhiNav clearfix">
            <ul>
                <li class="cur"><a href="#">普通标</a></li>
                <li><a href="#">优选智投</a></li>
                <li><a href="x-tou.jsp">X智投</a></li>
            </ul>
        </div>
        <div class="tiaojian clearfix" id="allTiaojian">
            <ul>
                <li id="cur" onclick="mot()" style="font-size: 12px;" >全部</li>
                <li id="cur1" onclick="mot1()" style="font-size: 12px;" value="1">近1个月</li>
                <li id="cur2" onclick="mot2()" style="font-size: 12px;" value="3">近3个月</li>
                <li id="cur3" onclick="mot3()"style="font-size: 12px;" value="123">近1年</li>
            </ul>
            <div class="riqi" id="allStatus" style="font-size: 12px">
                日期：
                <input type="text" id="startDate" style="font-size: 12px">
                <label>—</label>
                <input type="text" id="endDate" style="font-size: 12px">
             
             
                <button type="button" class="button button-sm button-special" id="riqiSearch">查询</button>
                <div class="datapicker touziRiqi" id="datapicker" style="display: none;"></div>
            </div>
...
<<<<<<< .mine
   ...
   <!--  <div class="answer" style="display:;"> -->
        <ul class="title">
            ...
            <li class="tar" style="width:11%;">交易时间</li>
            <li class="tar" style="width:11%;">计息时间</li>
...
=======
  ...
  <div class="answer" style="display: block;">
        <ul class="title" id="titleli">
            <li class="tal" style="box-sizing:border-box;padding-left:2%;">项目名称</li>
            <li class="tar" >交易时间</li>
            <li class="tar" >计息时间</li>
            <li class="tar" >投资本金(元)</li>
            <li class="tar" >预期收益(元)</li>
>>>>>>> .r76
            <li class="tar">预期利率</li>
            <li class="tar" >期限</li>
        </ul>
   	<ul class="title" id="ser">
   ...
   <%--  <div class="pageList" style="display:none ;"></div>
    <div class="empty" style="">
        <img src="${pageContext.request.contextPath }/statics/myzhanghu_files/empty1.png" alt="">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/DatePickerRange.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/riqiSearch.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/touzi-all.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/ancun.js.下载"></script>
<script type="text/javascript">
    $(function () {
    });
</script>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/myzhanghu2.js"></script>
</body>
</html>