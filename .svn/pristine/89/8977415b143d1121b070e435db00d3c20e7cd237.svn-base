...
<!-- saved from url=(0043)https://www.weidai.com.cn/account/myMessage -->
<html lang="zh-cn">
<head>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/statics/myzhanghu_files/message.css">
<div class="layout clearfix" style="margin-top:95px">
        ...
        <div class="mNav" id="mNavId">
            <ul><a href="myzhanghu.jsp">
                ...
                <a href="myzhanghu10.jsp">
                    <li class="cur"><i class="iconfont"></i>消息管理</li>
                </a>
            </ul>
        </div>
    </div>
    ...
    <!--用户中心左侧 end-->
    <!--用户中心内容-->
    <div class="memberContent fz14" id="">
        <div class="chongzhiTop">
            <!--新增消息管理开始-->
            <div><h3 class="fl">消息管理</h3><span class="fl lines"></span>

                <h3 class="fl">设置</h3>

                <div class="zdBtn fl ml20 zdBntOk" id="mesBtn">
                    <span>开</span>
                    <span>关</span>

                    <div class="bntW"></div>
                </div>
                <div class="fl ml10 choseTip">（通过短信提醒您标的和资金的变化）</div>
            </div>
            <!--新增消息管理结束-->
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/innerMessage.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/myzhanghu_files/common.js.下载"></script>
